...
?><script type="text/javascript">
    ...
    //$(function() {
    BX.ready(function() {
            $("#uf_crm_1530111488_wrap").hide();
            $("#uf_crm_1530111508_wrap").hide();
            $("#uf_crm_1530111528_wrap").hide();
            $("#uf_crm_1530111546_wrap").hide();
            $("#uf_crm_1530111565_wrap").hide();
		    <?php
            //$arUserGroupArray = CCrmPerms::GetUserPerms();
            global $USER;
            $user_id = $USER->GetID();
            /*
            //$arUserGroupArray = CCrmPerms::GetUserPermissions($user_id);
            $arUserGroupArray = CCrmPerms::GetUserPermissions(3);
            echo "******************arUserGroupArray********************\n";
                var_dump($arUserGroupArray->GetUserPerms());
            echo "**************************************\n";*/
            //echo "******************arUserGroupArray********************\n";
            ...
            $obRes = $DB->Query(
                "SELECT RR.* 
                    FROM 
                    b_crm_role_relation RR where RELATION = 'U".$user_id."'",
                false,
            ...
            {
                $arUserRoles[] = $arRow["ROLE_ID"];
            }



            $arUserGroupArray = $GLOBALS["USER"]->GetUserGroupArray();
            //if( in_array("1", $arUserGroupArray) or in_array("10", $arUserGroupArray) )
            if( in_array("1", $arUserGroupArray) or in_array("2", $arUserRoles) )
            {
            ?>
            $("#uf_crm_1530111488_wrap").show();
            $("#uf_crm_1530111508_wrap").show();
            $("#uf_crm_1530111528_wrap").show();
            $("#uf_crm_1530111546_wrap").show();
            $("#uf_crm_1530111565_wrap").show();
            <?php
            }
            ?>
