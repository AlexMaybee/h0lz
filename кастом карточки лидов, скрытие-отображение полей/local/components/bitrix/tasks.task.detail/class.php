...
final class TasksTaskDetailComponent extends TasksTaskComponent
{
	...
	protected function checkParameters()
	{
		...
		static::tryParseStringParameter($arParams['USER_ID'], (int) $USER->getId());
	...
	protected static function dispatch($request, array $arParams, array &$arResult, Collection $errors, array &$auxParams = array())
	{
		global $APPLICATION;

		$action = 	$auxParams['TRIGGER'];
