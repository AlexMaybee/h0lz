...
<div id="task-detail-buttons-div" class="webform-buttons task-buttons">
	...
	if ($arResult['SHOW_TIMER_NODE'] === 'Y')
	{
		...
		if($arResult['ALLOWED_ACTIONS']['ACTION_ACCEPT'])
		{
			// Legacy
		...
		if($arResult['ALLOWED_ACTIONS']['ACTION_COMPLETE'])
		{
			?><a onclick="
						...
						return false;" href="javascript:void(0);" class="webform-small-button webform-small-button-accept"><span class="webform-small-button-left"></span><span class="webform-small-button-text"><?php echo GetMessage("TASKS_CLOSE_TASK")?></span><span class="webform-small-button-right"></span></a>
				...
				<a onclick="
							...
							$.ajax({
							    type: 'POST',
							    url: '//'+window.location.hostname+':'+window.location.port+'/local/lib/taskAjax.php',
							    data: {'id':<?=$arResult['TASK']['ID'];?>},
							    success: function(data){
							    	console.log(data);
							    }
							});
							return false;" href="javascript:void(0);" class="webform-small-button webform-small-button-decline"><span class="webform-small-button-left"></span><span class="webform-small-button-text"><?php echo GetMessage("TASKS_CLOSE_TASK_TROBLE")?></span><span class="webform-small-button-right"></span></a>
							<?php
		}

		if($arResult['ALLOWED_ACTIONS']['ACTION_DECLINE'])
		{
			// Legacy
