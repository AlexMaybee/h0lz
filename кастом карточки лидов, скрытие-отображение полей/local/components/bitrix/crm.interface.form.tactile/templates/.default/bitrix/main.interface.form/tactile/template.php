...
foreach($arSections as &$arSection):
	...
	$pieces = explode("/", $_SERVER['SCRIPT_URL']);
	// print_r($pieces);
	foreach($arSection['FIELDS'] as $k => &$field):

		####################################################
		if($USER->GetID() == 9){
			if($pieces[3] == 'edit' && $pieces[2] == 'deal'){
				$arF = array('UF_CRM_1458297887', 'UF_CRM_1458300758', 'UF_CRM_1458298249', 'UF_CRM_1458300791');
				if(!in_array($field['id'], $arF)){
					continue;
				}
			}
		}
